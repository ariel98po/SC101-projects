...
def main():
    window = make_canvas(1000, 500)
    window.create_line(0, 0, 1000, 500, width=10, fill='magenta')
    window.create_text(800, 100, text='stanCode', anchor=tk.SW, fill='salmon', font='times 40')
    tk.mainloop()
